...
namespace TestConsoleClient.GameLogic_B
{
    class GameSkillManager
    {
        ...
        public void skill_16_DanceOfFire(Card_Control card_con)
        {
            ...
            else
            {
                ...
                if (GamePlayManager.Instance.thisturn)
                {
                    ...
                    {
                        item.BackgroundImage = global::TestConsoleClient.Properties.Resources.can_backimg_select;
                    }
                    GameBoard.P2_PlayerZone.BackgroundImage = global::TestConsoleClient.Properties.Resources.can_backimg_select;
                }
                else
                {
                    ...
                    GameBoard.P1_PlayerZone.BackgroundImage = global::TestConsoleClient.Properties.Resources.can_backimg_select;
        ...
        public bool canTargetSkill16(Card_Control card_con)
        {
            foreach (Card_Control item in GameBoard.P2_WarZone)
            {
                item.BackgroundImage = global::TestConsoleClient.Properties.Resources.backimg;
            }
            GameBoard.P2_PlayerZone.BackgroundImage = global::TestConsoleClient.Properties.Resources.backimg;
            foreach (Card_Control item in GameBoard.P1_WarZone)
            {
                item.BackgroundImage = global::TestConsoleClient.Properties.Resources.backimg;
            }
            GameBoard.P1_PlayerZone.BackgroundImage = global::TestConsoleClient.Properties.Resources.backimg;
