...
namespace WarLord_Server_GUI.GameLogic_B
{
    class GamePlayManager
    {
        ...
        //=====[게임 스킬 관련]=====
        private void gameSkill(Card_Control card_con)
        {
            Delegate dg;
            GameSkillManager.Instance.SkillDictionary.TryGetValue(card_con.card.Skill.ToString(), out dg);
